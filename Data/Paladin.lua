...
function Chronometer:PaladinSetup()
	...
	self:AddTimer(self.EVENT, BS["Judgement of Justice"],      10, 1,0,0, { cr="RED", xn=BS["Seal of Justice"]})
	self:AddTimer(self.EVENT, BS["Judgement of Light"],        10, 1,0,0, { cr="RED", xn=BS["Seal of Light"],  d={tn=BS["Lasting Judgement"], tb=10}})
	self:AddTimer(self.EVENT, BS["Judgement of Wisdom"],       10, 1,0,0, { cr="RED", xn=BS["Seal of Wisdom"], d={tn=BS["Lasting Judgement"], tb=10}})
	self:AddTimer(self.EVENT, BS["Judgement of the Crusader"], 10, 1,0,0, { cr="RED", xn=BS["Seal of the Crusader"]})
